...
const SiteItemBtn = styled.button`
  border: none;
`;
        ...
        <SiteSectionWrap>
          <SiteItem>
            <ItemWrapper>
              <SiteImg />
              <ItemSection>
                <SiteItemTitle>Lorem ipsum dolor</SiteItemTitle>
                <SiteItemInfo>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste
                  vel dolores explicabo aut accusamus doloribus? Molestiae quis
                  nam a ipsam, tempore officiis perspiciatis molestias neque
                  quod expedita. Culpa, consequuntur deleniti?
                </SiteItemInfo>
                <SiteItemBtn>+ View</SiteItemBtn>
              </ItemSection>
            </ItemWrapper>
          </SiteItem>
          <SiteItem>
